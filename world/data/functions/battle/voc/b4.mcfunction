...
summon minecraft:shulker 87 30 -144 {Color:8,CustomName:"樹林",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1200}],Health:1200.0f,Tags:["barr","tree","horse","building"],Team:b}
...
summon minecraft:shulker 96 30 -153 {Color:8,CustomName:"樹林",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1200}],Health:1200.0f,Tags:["barr","tree","horse","building"],Team:b}
...
summon minecraft:shulker 96 30 -180 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:500}],Health:500.0f,Tags:["red4","building","horse"],Team:red}
summon minecraft:shulker 87 30 -180 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:500}],Health:500.0f,Tags:["red4","building","horse"],Team:red}
summon minecraft:shulker 78 30 -180 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1000}],Health:1000.0f,Tags:["red2","building","horse"],Team:red}
summon minecraft:shulker 69 30 -180 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:500}],Health:500.0f,Tags:["red4","building","horse"],Team:red}
summon minecraft:shulker 60 30 -180 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:500}],Health:500.0f,Tags:["red4","building","horse"],Team:red}
summon minecraft:shulker 51 30 -180 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:500}],Health:500.0f,Tags:["red4","building","horse"],Team:red}
...
summon minecraft:shulker 60 30 -189 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:500}],Health:500.0f,Tags:["red4","building","horse"],Team:red}
...
summon minecraft:shulker 87 30 -198 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:100}],Health:100.0f,Tags:["red7","building","horse"],Team:red}
summon minecraft:shulker 78 30 -198 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:100}],Health:100.0f,Tags:["red5","building","horse"],Team:red}
summon minecraft:shulker 69 30 -198 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:100}],Health:100.0f,Tags:["red8","building","horse"],Team:red}
summon minecraft:shulker 60 30 -198 {Color:14,CustomName:"紅方",CustomNameVisible:1,NoAI:1b,Attributes:[{Name:generic.maxHealth,Base:1000}],Health:1000.0f,Tags:["red2","building","horse"],Team:red}
...
title @a subtitle ["",{"text":"- 熱蘭遮城的圍攻 -","color":"red"}]
