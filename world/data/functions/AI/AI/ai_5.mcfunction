...
# 作者: 灰塵
#########################################################################################################
execute @e[tag=cmd,score_buildt=36,score_buildt_min=36] ~ ~ ~ /scoreboard players set @e[tag=cmd] buildt 9
execute @e[tag=cmd,score_buildt=35,score_buildt_min=35] ~ ~ ~ /function ai:build/tower
execute @e[tag=cmd,score_buildt=34,score_buildt_min=34] ~ ~ ~ /function ai:soldier/vill
...
execute @e[tag=cmd,score_buildt=31,score_buildt_min=31] ~ ~ ~ /function ai:soldier/heavy_solider
...
execute @e[tag=cmd,score_buildt=26,score_buildt_min=26] ~ ~ ~ /function ai:build/Wall
execute @e[tag=cmd,score_buildt=25,score_buildt_min=25] ~ ~ ~ /function ai:soldier/heavy_solider
execute @e[tag=cmd,score_buildt=24,score_buildt_min=24] ~ ~ ~ /function ai:skip if @e[tag=barr]
execute @e[tag=cmd,score_buildt=24,score_buildt_min=24] ~ ~ ~ /function ai:build/grain_collector unless @e[tag=barr]
execute @e[tag=cmd,score_buildt=23,score_buildt_min=23] ~ ~ ~ /function ai:build/Wall
execute @e[tag=cmd,score_buildt=22,score_buildt_min=22] ~ ~ ~ /function ai:soldier/solider
execute @e[tag=cmd,score_buildt=21,score_buildt_min=21] ~ ~ ~ /function ai:skip if @e[tag=blue5]
execute @e[tag=cmd,score_buildt=21,score_buildt_min=21] ~ ~ ~ /function ai:build/military_camp unless @e[tag=blue5]
execute @e[tag=cmd,score_buildt=20,score_buildt_min=20] ~ ~ ~ /function ai:skip if @e[tag=s,team=red]
execute @e[tag=cmd,score_buildt=20,score_buildt_min=20] ~ ~ ~ /function ai:soldier/vill unless @e[tag=s,team=red]
