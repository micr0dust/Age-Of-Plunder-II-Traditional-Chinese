...
execute @e[tag=cmd,score_buildt=29,score_buildt_min=29] ~ ~ ~ /function ai:skip unless @e[tag=blue3]
execute @e[tag=cmd,score_buildt=29,score_buildt_min=29] ~ ~ ~ /function ai:build/command_center if @e[tag=blue3]
execute @e[tag=cmd,score_buildt=28,score_buildt_min=28] ~ ~ ~ /function ai:soldier/knight
...
execute @e[tag=cmd,score_buildt=21,score_buildt_min=21] ~ ~ ~ /function ai:soldier/knight
execute @e[tag=cmd,score_buildt=20,score_buildt_min=20] ~ ~ ~ /function ai:skip if @e[tag=blue7]
execute @e[tag=cmd,score_buildt=20,score_buildt_min=20] ~ ~ ~ /function ai:build/stable unless @e[tag=blue7]
