...
# 作者: 灰塵
#########################################################################################################
execute @e[tag=cmd,score_buildt=41,score_buildt_min=41] ~ ~ ~ /scoreboard players set @e[tag=cmd] buildt 8
execute @e[tag=cmd,score_buildt=40,score_buildt_min=40] ~ ~ ~ /function ai:build/military_camp
execute @e[tag=cmd,score_buildt=39,score_buildt_min=39] ~ ~ ~ /function ai:skip if @e[tag=blue5]
execute @e[tag=cmd,score_buildt=39,score_buildt_min=39] ~ ~ ~ /function ai:build/tower unless @e[tag=blue3]
execute @e[tag=cmd,score_buildt=38,score_buildt_min=38] ~ ~ ~ /function ai:soldier/vill
execute @e[tag=cmd,score_buildt=37,score_buildt_min=37] ~ ~ ~ /function ai:soldier/solider
execute @e[tag=cmd,score_buildt=36,score_buildt_min=36] ~ ~ ~ /function ai:soldier/vill
execute @e[tag=cmd,score_buildt=35,score_buildt_min=35] ~ ~ ~ /function ai:soldier/vill
execute @e[tag=cmd,score_buildt=34,score_buildt_min=34] ~ ~ ~ /function ai:soldier/solider
execute @e[tag=cmd,score_buildt=33,score_buildt_min=33] ~ ~ ~ /function ai:skip if @e[tag=s,team=red]
execute @e[tag=cmd,score_buildt=33,score_buildt_min=33] ~ ~ ~ /function ai:soldier/vill unless @e[tag=s,team=red]
execute @e[tag=cmd,score_buildt=32,score_buildt_min=32] ~ ~ ~ /function ai:skip if @e[tag=s,team=red]
execute @e[tag=cmd,score_buildt=32,score_buildt_min=32] ~ ~ ~ /function ai:soldier/vill unless @e[tag=s,team=red]
execute @e[tag=cmd,score_buildt=31,score_buildt_min=31] ~ ~ ~ /function ai:skip if @e[tag=s,team=red]
execute @e[tag=cmd,score_buildt=31,score_buildt_min=31] ~ ~ ~ /function ai:soldier/vill unless @e[tag=s,team=red]
execute @e[tag=cmd,score_buildt=30,score_buildt_min=30] ~ ~ ~ /function ai:build/tower
execute @e[tag=cmd,score_buildt=29,score_buildt_min=29] ~ ~ ~ /function ai:soldier/solider
execute @e[tag=cmd,score_buildt=28,score_buildt_min=28] ~ ~ ~ /function ai:skip if @e[tag=barr]
execute @e[tag=cmd,score_buildt=28,score_buildt_min=28] ~ ~ ~ /function ai:build/grain_collector unless @e[tag=barr]
execute @e[tag=cmd,score_buildt=27,score_buildt_min=27] ~ ~ ~ /function ai:soldier/vill
execute @e[tag=cmd,score_buildt=26,score_buildt_min=26] ~ ~ ~ /function ai:soldier/vill
execute @e[tag=cmd,score_buildt=25,score_buildt_min=25] ~ ~ ~ /function ai:soldier/vill
execute @e[tag=cmd,score_buildt=24,score_buildt_min=24] ~ ~ ~ /function ai:soldier/solider
execute @e[tag=cmd,score_buildt=23,score_buildt_min=23] ~ ~ ~ /function ai:soldier/vill
