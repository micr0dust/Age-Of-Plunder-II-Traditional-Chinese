...
# 作者: 灰塵
#########################################################################################################
execute @e[tag=cmd,score_buildt=20,score_buildt_min=20] ~ ~ ~ /scoreboard players set @e[tag=cmd] buildt 4

execute @e[tag=cmd,score_buildt=19,score_buildt_min=19] ~ ~ ~ /function ai:skip unless @e[tag=blue3]
execute @e[tag=cmd,score_buildt=19,score_buildt_min=19] ~ ~ ~ /function ai:build/tower if @e[tag=blue3]
...
execute @e[tag=cmd,score_buildt=14,score_buildt_min=14] ~ ~ ~ /function ai:build/tower
execute @e[tag=cmd,score_buildt=13,score_buildt_min=13] ~ ~ ~ /function ai:soldier/solider
execute @e[tag=cmd,score_buildt=12,score_buildt_min=12] ~ ~ ~ /function ai:skip if @e[tag=barr]
execute @e[tag=cmd,score_buildt=12,score_buildt_min=12] ~ ~ ~ /function ai:build/grain_collector unless @e[tag=barr]
