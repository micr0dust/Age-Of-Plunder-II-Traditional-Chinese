...
#AI升級
#1
execute @e[score_aibuild=1,score_aibuild_min=1,tag=cmd,score_gamemode=1,score_gamemode_min=1,score_bwood_min=90,score_baslvl=3] ~ ~ ~ scoreboard players add @e[tag=cmd] upgrades 4
execute @e[score_aibuild=1,score_aibuild_min=1,tag=cmd,score_gamemode=1,score_gamemode_min=1,score_bwood_min=90,score_baslvl=3] ~ ~ ~ scoreboard players remove @e[tag=cmd] bwood 4
...
execute @e[score_aibuild=1,score_aibuild_min=1,tag=cmd,score_gamemode=1,score_gamemode_min=1,score_upgrades_min=80,score_baslvl=3] ~ ~ ~ scoreboard players remove @e[tag=cmd] bwood 80
...
#AI升級
#2
execute @e[score_aibuild=2,score_aibuild_min=2,tag=cmd,score_gamemode=1,score_gamemode_min=1,score_bwood_min=90,score_bahlvl=1] ~ ~ ~ scoreboard players add @e[tag=cmd] upgrades 4
execute @e[score_aibuild=2,score_aibuild_min=2,tag=cmd,score_gamemode=1,score_gamemode_min=1,score_bwood_min=90,score_bahlvl=1] ~ ~ ~ scoreboard players remove @e[tag=cmd] bwood 4
...
execute @e[score_aibuild=1,score_aibuild_min=1,tag=cmd,score_gamemode=1,score_gamemode_min=1,score_upgrades_min=155,score_bahlvl=1] ~ ~ ~ scoreboard players remove @e[tag=cmd] bwood 155
...
#AI升級
#3
execute @e[score_aibuild=3,score_aibuild_min=3,tag=cmd,score_gamemode=1,score_gamemode_min=1,score_bwood_min=90,score_raslvl=3] ~ ~ ~ scoreboard players add @e[tag=cmd] upgrades 4
execute @e[score_aibuild=3,score_aibuild_min=3,tag=cmd,score_gamemode=1,score_gamemode_min=1,score_bwood_min=90,score_raslvl=3] ~ ~ ~ scoreboard players remove @e[tag=cmd] bwood 4
...
execute @e[score_aibuild=1,score_aibuild_min=1,tag=cmd,score_gamemode=1,score_gamemode_min=1,score_upgrades_min=130,score_brlvl=3] ~ ~ ~ scoreboard players remove @e[tag=cmd] bwood 130
