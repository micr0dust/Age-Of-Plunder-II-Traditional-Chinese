...
execute @e[tag=bluefollow] ~ ~ ~ /summon minecraft:armor_stand ~ ~ ~ {PersistenceRequired:1b,CustomName:"軍隊跟隨",UUIDMost:1212L,UUIDLeast:1212L,CustomNameVisible:0b,Tags:["flat","horse","follow","bfollow"],Invulnerable:1,Invisible:1}
...
execute @e[tag=redfollow] ~ ~ ~ /summon minecraft:armor_stand ~ ~ ~ {PersistenceRequired:1b,CustomName:"軍隊跟隨",UUIDMost:2121L,UUIDLeast:2121L,CustomNameVisible:0b,Tags:["flat","horse","follow","rfollow"],Invulnerable:1,Invisible:1}
...
execute @e[tag=cmd,score_bciv=0] ~ ~ ~ execute @e[tag=bluebopt] ~ ~ ~ execute @e[tag=blue2,c=1,r=4] ~ ~ ~ tellraw @p[team=blue] ["",{"text":"[\u6b65\u5175]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger ba25 set 1"}},{"text":" 8","color":"dark_red"},{"text":"\n"},{"text":"[\u5f13\u5175]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger ba28 set 1"}},{"text":" 8","color":"dark_red"},{"text":" 4","color":"dark_green"},{"text":"\n"},{"text":"[\u7f8a\u99dd\u9a0e\u58eb]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger ba27 set 1"}},{"text":" 10","color":"dark_red"},{"text":" 2","color":"gold"}]
#--堡兵
#波斯
execute @e[tag=cmd,score_bciv=1,score_bciv_min=1] ~ ~ ~ execute @e[tag=bluebopt] ~ ~ ~ execute @e[tag=blue2,c=1,r=4] ~ ~ ~ tellraw @p[team=blue] ["",{"text":"[\u4e0d\u6b7b\u8ecd\u5718]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger bspecial set 1"}},{"text":" 10","color":"dark_red"},{"text":" 6","color":"gold"}]
#歌德
execute @e[tag=cmd,score_bciv=2,score_bciv_min=2] ~ ~ ~ execute @e[tag=bluebopt] ~ ~ ~ execute @e[tag=blue2,c=1,r=4] ~ ~ ~ tellraw @p[team=blue] ["",{"text":"[\u6b4c\u5fb7\u885b\u968a]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger bspecial set 2"}},{"text":" 10","color":"dark_red"},{"text":" 5","color":"gold"}]
#拜占庭
execute @e[tag=cmd,score_bciv=3,score_bciv_min=3] ~ ~ ~ execute @e[tag=bluebopt] ~ ~ ~ execute @e[tag=blue2,c=1,r=4] ~ ~ ~ tellraw @p[team=blue] ["",{"text":"[\u8056\u9a0e\u5175]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger bspecial set 3"}},{"text":" 12","color":"dark_red"},{"text":" 10","color":"gold"}]
#不列顛
execute @e[tag=cmd,score_bciv=4,score_bciv_min=4] ~ ~ ~ execute @e[tag=bluebopt] ~ ~ ~ execute @e[tag=blue2,c=1,r=4] ~ ~ ~ tellraw @p[team=blue] ["",{"text":"[\u9577\u5f13\u5175]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger bspecial set 4"}},{"text":" 10","color":"dark_red"},{"text":" 10","color":"dark_green"}]
#維京
execute @e[tag=cmd,score_bciv=5,score_bciv_min=5] ~ ~ ~ execute @e[tag=bluebopt] ~ ~ ~ execute @e[tag=blue2,c=1,r=4] ~ ~ ~ tellraw @p[team=blue] ["",{"text":"[\u72c2\u6230\u58eb]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger bspecial set 5"}},{"text":" 12","color":"dark_red"},{"text":" 5","color":"gold"}]
#阿拉伯
execute @e[tag=cmd,score_bciv=6,score_bciv_min=6] ~ ~ ~ execute @e[tag=bluebopt] ~ ~ ~ execute @e[tag=blue2,c=1,r=4] ~ ~ ~ tellraw @p[team=blue] ["",{"text":"[\u5974\u96b8\u5175]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger bspecial set 6"}},{"text":" 12","color":"dark_red"},{"text":" 6","color":"gold"}]
...
execute @e[tag=cmd,score_rciv=0] ~ ~ ~ execute @e[tag=redbopt] ~ ~ ~ execute @e[tag=red2,c=1,r=4] ~ ~ ~ tellraw @p[team=red] ["",{"text":"[\u6b65\u5175]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger ra25 set 1"}},{"text":" 8","color":"dark_red"},{"text":"\n"},{"text":"[\u5f13\u5175]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger ra28 set 1"}},{"text":" 8","color":"dark_red"},{"text":" 4","color":"dark_green"},{"text":"\n"},{"text":"[\u7f8a\u99dd\u9a0e\u58eb]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger ra27 set 1"}},{"text":" 10","color":"dark_red"},{"text":" 2","color":"gold"}]
#紅隊建築開啟音效
...
#--堡兵
#波斯
execute @e[tag=cmd,score_rciv=1,score_rciv_min=1] ~ ~ ~ execute @e[tag=redbopt] ~ ~ ~ execute @e[tag=red2,c=1,r=4] ~ ~ ~ tellraw @p[team=red] ["",{"text":"[\u4e0d\u6b7b\u8ecd\u5718]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger rspecial set 1"}},{"text":" 10","color":"dark_red"},{"text":" 6","color":"gold"}]
#歌德
execute @e[tag=cmd,score_rciv=2,score_rciv_min=2] ~ ~ ~ execute @e[tag=redbopt] ~ ~ ~ execute @e[tag=red2,c=1,r=4] ~ ~ ~ tellraw @p[team=red] ["",{"text":"[\u6b4c\u5fb7\u885b\u968a]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger rspecial set 2"}},{"text":" 10","color":"dark_red"},{"text":" 5","color":"gold"}]
#拜占庭
execute @e[tag=cmd,score_rciv=3,score_rciv_min=3] ~ ~ ~ execute @e[tag=redbopt] ~ ~ ~ execute @e[tag=red2,c=1,r=4] ~ ~ ~ tellraw @p[team=red] ["",{"text":"[\u8056\u9a0e\u5175]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger rspecial set 3"}},{"text":" 12","color":"dark_red"},{"text":" 10","color":"gold"}]
#不列顛
execute @e[tag=cmd,score_rciv=4,score_rciv_min=4] ~ ~ ~ execute @e[tag=redbopt] ~ ~ ~ execute @e[tag=red2,c=1,r=4] ~ ~ ~ tellraw @p[team=red] ["",{"text":"[\u9577\u5f13\u5175]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger rspecial set 4"}},{"text":" 10","color":"dark_red"},{"text":" 10","color":"dark_green"}]
#維京
execute @e[tag=cmd,score_rciv=5,score_rciv_min=5] ~ ~ ~ execute @e[tag=redbopt] ~ ~ ~ execute @e[tag=red2,c=1,r=4] ~ ~ ~ tellraw @p[team=red] ["",{"text":"[\u72c2\u6230\u58eb]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger rspecial set 5"}},{"text":" 12","color":"dark_red"},{"text":" 5","color":"gold"}]
#阿拉伯
execute @e[tag=cmd,score_rciv=6,score_rciv_min=6] ~ ~ ~ execute @e[tag=redbopt] ~ ~ ~ execute @e[tag=red2,c=1,r=4] ~ ~ ~ tellraw @p[team=red] ["",{"text":"[\u5974\u96b8\u5175]","color":"yellow","clickEvent":{"action":"run_command","value":"/trigger rspecial set 6"}},{"text":" 12","color":"dark_red"},{"text":" 6","color":"gold"}]
