...
execute @e[tag=des] ~ ~ ~ /give @p minecraft:silver_shulker_box 1 0 {display:{Name:"§0拆除山脈",Lore:["(對著核心按Q使用)會拆除距離2格內的山脈核心"]},des:1b,ench:[{id:71,lvl:3}]}
...
execute @e[tag=blueFollowStop] ~ ~ ~ /give @p[team=blue] minecraft:golden_horse_armor 1 0 {display:{Name:"§9軍隊跟隨",Lore:["(拿著按Q使用)你周圍的士兵將會跟隨你","(限1人使用)"]},bluefollow:1b,ench:[{id:71,lvl:3}]}
...
execute @e[tag=redFollowStop] ~ ~ ~ /give @p[team=red] minecraft:golden_horse_armor 1 0 {display:{Name:"§c軍隊跟隨",Lore:["(拿著按Q使用)你周圍的士兵將會跟隨你","(限1人使用)"]},redfollow:1b,ench:[{id:71,lvl:3}]}
...
execute @e[tag=bluevf] ~ ~ ~ /give @p[team=blue] minecraft:barrier 1 0 {display:{Name:"§9村民跟隨停止",Lore:["(拿著按Q使用)停止村民跟隨"]},bluevfStop:1b,ench:[{id:71,lvl:3}]}
...
execute @e[tag=redvf] ~ ~ ~ /give @p[team=red] minecraft:barrier 1 0 {display:{Name:"§c村民跟隨停止",Lore:["(拿著按Q使用)停止村民跟隨"]},redvfStop:1b,ench:[{id:71,lvl:3}]}
...
execute @e[tag=bluevfStop] ~ ~ ~ /give @p[team=blue] minecraft:wheat 1 0 {display:{Name:"§9村民跟隨",Lore:["(拿著按Q使用)離你3格內的村民一直會跟隨你","(限1人使用)"]},bluevf:1b,ench:[{id:71,lvl:3}]}
...
execute @e[tag=redvfStop] ~ ~ ~ /give @p[team=red] minecraft:wheat 1 0 {display:{Name:"§c村民跟隨",Lore:["(拿著按Q使用)離你3格內的村民會一直跟隨你","(限1人使用)"]},redvf:1b,ench:[{id:71,lvl:3}]}
...
execute @e[tag=blueshop] ~ ~ ~ give @p[team=blue] minecraft:nether_star 1 0 {display:{Name:"§9開啟商店",Lore:["(拿著按Q使用)可以開啟商店"]},blueshop:1b,ench:[{id:71,lvl:3}]}
...
execute @e[tag=redshop] ~ ~ ~ give @p[team=red] minecraft:nether_star 1 0 {display:{Name:"§c開啟商店",Lore:["(拿著按Q使用)可以開啟商店"]},redshop:1b,ench:[{id:71,lvl:3}]}
...
execute @e[tag=bluemarket] ~ ~ ~ /give @p[team=blue] minecraft:gold_ingot 1 0 {display:{Name:"§9市集",Lore:["(拿著按Q使用)資源互換"]},bluemarket:1b,ench:[{id:71,lvl:3}]}
...
execute @e[tag=redmarket] ~ ~ ~ /give @p[team=red] minecraft:gold_ingot 1 0 {display:{Name:"§c市集",Lore:["(拿著按Q使用)資源互換"]},redmarket:1b,ench:[{id:71,lvl:3}]}
