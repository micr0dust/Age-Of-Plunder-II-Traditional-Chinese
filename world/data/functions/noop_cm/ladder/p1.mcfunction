...
tellraw @a ["",{"text":"(1) "},{"text":"micro_dust","color":"yellow"},{"text":" 12581","color":"green"},{"text":" "},{"text":"[▶]","color":"red","clickEvent":{"action":"open_url","value":"https://youtu.be/d5H9KmuW-Ng"},"hoverEvent":{"action":"show_text","value":[{"translate":"aop.challenge.video"}]}}]
