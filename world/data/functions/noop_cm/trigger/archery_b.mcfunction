...
#########################################################################################################
#---弓兵
execute @p[score_ba8=1,score_ba8_min=1] ~ ~ ~ function noop_cm:buy/noresoure unless @e[tag=cmd,score_bfood_min=4,score_bwood_min=4]
execute @p[score_ba8=1,score_ba8_min=1] ~ ~ ~ function noop_cm:buy/a8/blue if @e[tag=cmd,score_bfood_min=4,score_bwood_min=4]
#---馬弓騎兵
