...
# 作者: 灰塵
#########################################################################################################
scoreboard players set @p[team=red] AItest 1
...
execute @e[tag=cmd,score_ar4=1,score_ar4_min=1] ~ ~ ~ execute @p[team=red,score_red_build=4,score_red_build_min=4,score_AItest_min=1] ~ ~ ~ function noop_cm:buy/noresoure unless @e[tag=cmd,score_stop=0,score_stop_min=0,score_rwood_min=10]
execute @e[tag=cmd,score_ar4=4,score_ar4_min=4] ~ ~ ~ execute @p[team=red,score_red_build=4,score_red_build_min=4,score_AItest_min=1] ~ ~ ~ function noop_cm:buy/noresoure unless @e[tag=cmd,score_stop=0,score_stop_min=0,score_rwood_min=7]
execute @e[tag=cmd,score_ar5=1,score_ar5_min=1] ~ ~ ~ execute @p[team=red,score_red_build=5,score_red_build_min=5,score_AItest_min=1] ~ ~ ~ function noop_cm:buy/noresoure unless @e[tag=cmd,score_stop=0,score_stop_min=0,score_rwood_min=20]
execute @e[tag=cmd,score_ar5=2,score_ar5_min=2] ~ ~ ~ execute @p[team=red,score_red_build=5,score_red_build_min=5,score_AItest_min=1] ~ ~ ~ function noop_cm:buy/noresoure unless @e[tag=cmd,score_stop=0,score_stop_min=0,score_rwood_min=15]
...
execute @e[tag=cmd,score_ar4=1,score_ar4_min=1] ~ ~ ~ execute @p[team=red,score_red_build=4,score_red_build_min=4,score_AItest_min=1] ~ ~ ~ function noop_cm:shop/red4 if @e[tag=cmd,score_stop=0,score_stop_min=0,score_rwood_min=10]
execute @e[tag=cmd,score_ar4=4,score_ar4_min=4] ~ ~ ~ execute @p[team=red,score_red_build=4,score_red_build_min=4,score_AItest_min=1] ~ ~ ~ function noop_cm:shop/red4 if @e[tag=cmd,score_stop=0,score_stop_min=0,score_rwood_min=7]
execute @e[tag=cmd,score_ar5=1,score_ar5_min=1] ~ ~ ~ execute @p[team=red,score_red_build=5,score_red_build_min=5,score_AItest_min=1] ~ ~ ~ function noop_cm:shop/red5 if @e[tag=cmd,score_stop=0,score_stop_min=0,score_rwood_min=20]
execute @e[tag=cmd,score_ar5=2,score_ar5_min=2] ~ ~ ~ execute @p[team=red,score_red_build=5,score_red_build_min=5,score_AItest_min=1] ~ ~ ~ function noop_cm:shop/red5 if @e[tag=cmd,score_stop=0,score_stop_min=0,score_rwood_min=15]
