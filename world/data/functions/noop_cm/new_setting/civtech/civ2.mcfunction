...
#   ⬤───⬤
#	 
tellraw @a ["",{"text":" ⬤","hoverEvent":{"action":"show_text","value":"堡壘  攻擊隨防禦塔升級(垛孔>箭狹槽)"}},{"text":"──"},{"text":"⬤","hoverEvent":{"action":"show_text","value":"歌德衛隊"}}]
...
#   ⬤───❶───❷
#
tellraw @a ["",{"text":" ⬤","color":"yellow","hoverEvent":{"action":"show_text","value":"防禦塔"}},{"text":"──","color":"yellow"},{"text":"❶","color":"yellow","hoverEvent":{"action":"show_text","value":"垛孔"}},{"text":"───","color":"gray"},{"text":"❷","color":"gray","hoverEvent":{"action":"show_text","value":"箭狹槽"}}]
...
#   ⬤
#
tellraw @a {"text":" ⬤","color":"gray","hoverEvent":{"action":"show_text","value":"石牆"}}
...
tellraw @a ["",{"text":"      ├───","color":"gold"},{"text":"⬤","color":"gold","hoverEvent":{"action":"show_text","value":"重裝步兵"}},{"text":"───","color":"gold"},{"text":"❶","color":"gold","hoverEvent":{"action":"show_text","value":"精銳重裝步兵"}},{"text":"───","color":"gold"},{"text":"❷","color":"gold","hoverEvent":{"action":"show_text","value":"高級重裝步兵"}},{"text":"───","color":"gold"},{"text":"❸","color":"gold","hoverEvent":{"action":"show_text","value":"特級重裝步兵"}}]
tellraw @a ["",{"text":"      └───","color":"gold"},{"text":"⬤","color":"gold","hoverEvent":{"action":"show_text","value":"歌德衛隊"}}]
...
tellraw @a ["",{"text":"      └───","color":"blue"},{"text":"⬤","color":"blue","hoverEvent":{"action":"show_text","value":"騎士"}},{"text":"───","color":"gray"},{"text":"❶","color":"gray","hoverEvent":{"action":"show_text","value":"重裝騎兵"}}]
