...
#   ⬤───⬤
#	 
tellraw @a ["",{"text":" ⬤","hoverEvent":{"action":"show_text","value":"堡壘  攻擊隨防禦塔升級(垛孔>箭狹槽)"}},{"text":"──"},{"text":"⬤","hoverEvent":{"action":"show_text","value":"狂戰士"}}]
...
tellraw @a ["",{"text":" ⬤","color":"gray","hoverEvent":{"action":"show_text","value":"馬廄"}},{"text":"──┤","color":"gray"}]
