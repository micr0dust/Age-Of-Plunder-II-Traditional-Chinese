...
#   ⬤───⬤
#	 
tellraw @a ["",{"text":" ⬤","hoverEvent":{"action":"show_text","value":[{"translate":"aop.build2_1"}]}},{"text":"──"},{"text":"⬤","hoverEvent":{"action":"show_text","value":[{"translate":"aop.unit.sp5"}]}}]
...
tellraw @a ["",{"text":" ⬤","color":"gray","hoverEvent":{"action":"show_text","value":[{"translate":"aop.build7"}]}},{"text":"──┤","color":"gray"}]
