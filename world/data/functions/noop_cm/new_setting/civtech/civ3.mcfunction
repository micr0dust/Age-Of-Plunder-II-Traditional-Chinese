...
#   ⬤───⬤
#	 
tellraw @a ["",{"text":" ⬤","hoverEvent":{"action":"show_text","value":[{"translate":"aop.build2_1"}]}},{"text":"──"},{"text":"⬤","hoverEvent":{"action":"show_text","value":[{"translate":"aop.unit.sp3"}]}}]
...
tellraw @a ["",{"text":"      └───","color":"gold"},{"text":"⬤","color":"gold","hoverEvent":{"action":"show_text","value":[{"translate":"aop.tree.upgrade.a5v5_1"}]}},{"text":"───","color":"gold"},{"text":"❶","color":"gold","hoverEvent":{"action":"show_text","value":[{"translate":"aop.tree.upgrade.a5v5"}]}},{"text":"───","color":"gray"},{"text":"❷","color":"gray","hoverEvent":{"action":"show_text","value":[{"translate":"aop.tree.upgrade.a5v6"}]}},{"text":"───","color":"gray"},{"text":"❸","color":"gray","hoverEvent":{"action":"show_text","value":[{"translate":"aop.tree.upgrade.a5v7"}]}}]
...
#       └───⬤───❷
#
tellraw @a ["",{"text":"      ┌───","color":"blue"},{"text":"⬤","color":"blue","hoverEvent":{"action":"show_text","value":[{"translate":"aop.tree.upgrade.a7v1"}]}},{"text":"───","color":"gray"},{"text":"❶","color":"gray","hoverEvent":{"action":"show_text","value":[{"translate":"aop.tree.upgrade.a7v2"}]}}]
