...
#   ⬤───⬤
#	 
tellraw @a ["",{"text":" ⬤","hoverEvent":{"action":"show_text","value":[{"translate":"aop.build2_1"}]}},{"text":"──"},{"text":"⬤","hoverEvent":{"action":"show_text","value":[{"translate":"aop.unit.sp1"}]}}]
