...
#   ⬤───⬤
#	 
tellraw @a ["",{"text":"      ┌───"},{"text":"⬤","hoverEvent":{"action":"show_text","value":"步兵  隨軍營升級(民兵>劍兵>長劍兵>精銳士兵)"}}]
tellraw @a ["",{"text":" ⬤","hoverEvent":{"action":"show_text","value":"堡壘  攻擊隨防禦塔升級(垛孔>箭狹槽)"}},{"text":"──┼───"},{"text":"⬤","hoverEvent":{"action":"show_text","value":"羊駝騎士  隨馬廄升級(羊駝騎士>重裝羊駝騎士)"}}]
tellraw @a ["",{"text":"      └───"},{"text":"⬤","hoverEvent":{"action":"show_text","value":"弓兵"}}]
