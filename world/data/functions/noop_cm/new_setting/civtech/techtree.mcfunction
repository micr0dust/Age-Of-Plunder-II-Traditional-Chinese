...
#   ⬤───⬤
#	 
tellraw @a ["",{"text":"      ┌───"},{"text":"⬤","hoverEvent":{"action":"show_text","value":[{"translate":"aop.unit.a2a5"}]}}]
tellraw @a ["",{"text":" ⬤","hoverEvent":{"action":"show_text","value":[{"translate":"aop.build2_1"}]}},{"text":"──┼───"},{"text":"⬤","hoverEvent":{"action":"show_text","value":[{"translate":"aop.unit.a2a7"}]}}]
tellraw @a ["",{"text":"      └───"},{"text":"⬤","hoverEvent":{"action":"show_text","value":[{"translate":"aop.unit.a8a"}]}}]
...
#       └───⬤───❷───❸───❹
#	
tellraw @a ["",{"text":"      ┌───","color":"gold"},{"text":"⬤","color":"gold","hoverEvent":{"action":"show_text","value":[{"translate":"aop.tree.upgrade.a5v1"}]}},{"text":"───","color":"gold"},{"text":"❶","color":"gold","hoverEvent":{"action":"show_text","value":[{"translate":"aop.tree.upgrade.a5v2"}]}},{"text":"───","color":"gold"},{"text":"❷","color":"gold","hoverEvent":{"action":"show_text","value":[{"translate":"aop.tree.upgrade.a5v3"}]}},{"text":"───","color":"gold"},{"text":"❸","color":"gold","hoverEvent":{"action":"show_text","value":[{"translate":"aop.tree.upgrade.a5v4"}]}},{"text":" "}]
